...
let requestUrl: string = 'http://localhost:3000/product/id';
...
http.onload = function() {
    if (this.readyState === 4 && this.status === 200) {
        ...
        let outputGach: string = "";
        let outputDa: string = "";
        let outputHienDai: string = "";
        let outputDonGian: string = "";
        let outputAmCung: string = "";
        let countGach: number = 0;
        let countDa: number = 0;
        let countHienDai: number = 0;
        let countDonGian: number = 0;
        let countAmCung: number = 0;
